...
var WooGridView = function WooGridView(selector) {
  _classCallCheck(this, WooGridView);

  var container = this.container = document.querySelector(selector);
    ...
    methods: {
      filter: function filter() {
        ...
        filterTimeout = setTimeout(function () {
          document.querySelector(selector + ' .filters-form').submit();
        }, 500);
      },
      sort: function sort(column) {//this.
      }
    }
  });
};
